...
module.exports = {
  ...
  attributes: {
    ...
    isSuperAdmin: {
      ...
      extendedDescription: `SuperAdmins can :
      - add/remove developers to project
      - CRUD Projects and add devs to it
      - CRUD Tasks
      - CRUD Developers
      - Promote Devs to Managers
      `,
    },
...
email status until they click the link in the confirmation email.`
    ...
    isManager: {
      ...
      extendedDescription: `Managers can :
      - add/remove developers to project
      - CRUD Projects and add devs to it
      - CRUD Tasks
      - R Developer profile pages
      `,
    },
    ...
    monthlySalary: {
      ...
      extendedDescription: `
        Every employee has a different paygrade.
      `,
    },

    overtimeRate: {
      type: 'number',
      description: 'The overtime rate recieved for working overtime on projects',
